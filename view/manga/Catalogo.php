    ...
    <div class="Filtros">
        <form id="form-filtros">
            <fieldset class="filtro-categoria" id="filtro-tipo">
                ...
                <label><input type="radio" name="tipo" value="lightnovel" onchange="aplicarFiltros()"> Light
                    Novel</label><br>
        ...
        <form id="form-filtros2">
            <fieldset class="filtro-categoria" id="filtro-tipo">
                <legend>Tipo</legend>
                <label><input id="fechaInicio" type="text" name="tipo" value="1934" style="width: 40px;"
                        onkeydown="cambioFecha(event)"> Año de Inicio</label><br>
                <label><input id="fechaFinal" type="text" name="tipo" value="2025" style="width: 40px;"
                        onkeydown="cambioFecha(event)"> Año ......Final</label><br> <!-- Alineado con psint -->
            </fieldset>
        </form>
    </div>
